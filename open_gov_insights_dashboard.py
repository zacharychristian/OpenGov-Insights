...
# Clean datatypes
filter_table_df['num_contracts'] = pd.to_numeric(filter_table_df['num_contracts'], errors='coerce')
filter_table_df['direct_payments'] = pd.to_numeric(filter_table_df['direct_payments'], errors='coerce')
filter_table_df['grants'] = pd.to_numeric(filter_table_df['grants'], errors='coerce')
filter_table_df['idvs'] = pd.to_numeric(filter_table_df['idvs'], errors='coerce')
filter_table_df['loans'] = pd.to_numeric(filter_table_df['loans'], errors='coerce')
filter_table_df['other'] = pd.to_numeric(filter_table_df['other'], errors='coerce')
